...
![Step](../screenshots/2/2.2.1.01.png)
...
![Step](../screenshots/2/2.2.2.01.png)
...
![Step](../screenshots/2/2.2.3.01.png)
...
![Step](../screenshots/2/2.3.2.01.png)

## 2.3.3. Accessing the Imported Notebook
After the import completes, locate the newly imported notebook in the `urban-innovation-de{NNN}`, where NNN represents the number assigned to you.For convenience, you can open the notebook in the background, which will make its icon continuously accessible from the vertical sidebar on the left.
![Step](../screenshots/2/2.3.3.01.png)
...
![Step](../screenshots/2/2.4.3.01.png)
...
## 2.5.1. Click on the `Add data items`, `bronzerawdata`. Then select `New Lakehouse`.
![Step](../screenshots/2/2.5.1.01.png)

## 2.5.2. Follow the naming convention and enter a name for the Lakehouse. The suggested name is `silvercleansed`.
![Step](../screenshots/2/2.5.1.02.png)
...
![Step](../screenshots/2/2.5.1.03.png)
...
## 2.7.1. **Data Pipeline Creation**

Make sure you are in your fabric workspace, then press New item and then choose Data pipeline.
![Step](../screenshots/2/2.7.1.png)

Name the new pipeline `Bronze2Silver`.
![Step](../screenshots/2/2.7.1.02.png)

## 2.7.2. **Pipeline Activity**
Select the `ForEach` activity as shown on the screen.
![Step](../screenshots/2/2.7.2.png)

## 2.7.3. **General Settings for Each Activity**
Provide a name for each `ForEach` element.
![Step](../screenshots/2/2.7.3.png)

## 2.7.4. **Pipeline Variables**
Firstly, click on the background pane (first step from the screenshot) to see the tab with parameters and variables.
...
![Step](../screenshots/2/2.7.4.png)

## 2.7.5. **ForEach Settings**
...
## 2.7.6. **Adding Notebook Activity**
Now press "Activities" (1) and then choose "Notebook".
![Step](../screenshots/2/2.7.6.png)

## 2.7.7. **Notebook Settings**
From the General Tab (presented in the screenshot), go the `Settings` tab for the notebook, as illustrated.
![Step](../screenshots/2/2.7.7.png)

## 2.7.8. **Select Workspace and Notebook**
Choose your workspace and then select `notebook-2` that you uploaded previously.
![Step](../screenshots/2/2.7.8.png)

## 2.7.9. **Select Base Parameters**
Select Base Parameters and add a new parameter named `table_name`, with type `String` and value `@item()`. `@item()` comes again from dynamic content (Pipeline expression builder).

![Step](../screenshots/2/2.7.9.png)

## 2.7.10. **Validation**
After configuring, click `Validate` to ensure there are no errors. Click on `Run`.
![Step](../screenshots/2/2.7.10.png)

## 2.7.11. **Execution**
Save the settings and initiate the run by clicking the `Run` button.
![Step](../screenshots/2/2.7.11.png)
...
## 2.9.1. From your workspace, click on the `New Item` button then select `Lakehouse` . Adhere to the naming convention and enter a name for the Lakehouse. The suggested name is `goldcurated`. Click 'Create'.
![Step](../screenshots/2/2.9.01.png)

## 2.9.2. Confirm that your Gold Lakehouse has been created.
![Step](../screenshots/2/2.9.02.png)
